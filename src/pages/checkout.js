...
import mygif from '../../public/cart.gif'
        ...
        <main className='lg:flex max-w-screen-2xl mx-auto my-auto'>
           {/*left */}
            ...
            <div className='flex flex-col items-center  p-5 space-y-10 bg-white'>
                <h1 className='text-3xl border-b pb-4'>{items.length===0?"":"shopping basket"}
                    {items.length===0&&<div><Image src={mygif} width={400}  alt="" /></div>}
                </h1>
